...
joten hyvien kääntäjien valmistuttua oli laitteisto usein jo vanhentunut (ibid).
...
välikieliratkaisussa vain N+M kääntäjää ~\cite[15]{Speetjens76}. Toisin sanoen kääntäjien määrä kasvaisi
...
kieli oli Melvin Conwayn 1958 julkaisema välikieli. Conwayn julkaisussa
\emph{Proposal for an UNCOL}
määritellään matalan tason välikieli, jota hän kutsuu SML:ksi (Simple Machine Language) ~\cite[5]{Conway58}.
%miks vitus toho ei tuu välii
...
tehokkaan välikielen kehittämiseksi, mikäli tavoiteltujen kohdelaitteistojen
määrää pienennetään. Suurin osa eniten käytetyistä tietokoneista toimii
niin samankaltaisesti, että hyvä välikieli kykenee kattamaan niistä suurimman osan (ibid).
...
Kääntäjällä tarkoitetaan ohjelmaa, joka kääntää lähdekielisen ohjelmakoodin
