...
kuvausj‰rjestelmien kehitys sek‰ koodin generointi mahdollistivat
tehokkaampien ohjelmointikielten k‰ytˆn ohjelmoinnissa. Nykyisin k‰ytˆss‰ olevat
...
Myˆhemmin yleistyi k‰yt‰ntˆ, jossa k‰‰nnˆs toteutetaan jonkin v‰likielen
...
vastaavaan takaosaan. Kehittyneet k‰‰nt‰j‰rakenteet mahdollistavat
myˆs niiden ketjuttamisen uusille laitteistoille.
...
laitteistoissa. Koska eri laitteistoissa on erilaiset k‰skykannat, poistuu korkean
tason ohjelmointikieli‰ k‰ytt‰m‰ll‰ tarve uudelleenohjelmoinnille. 
...
%rakenne
T‰ss‰ tutkielmassa k‰sitell‰‰n k‰‰nt‰jien ja ohjelmointikielten historiaa. K‰‰nt‰jien
toteutusta k‰sitell‰‰n karkealla tasolla. Luvut kaksi ja kolme k‰sittelev‰t l‰hinn‰ historiaa.
Ensin k‰sitell‰‰n symbolisia konekieli‰ sek‰ assemblyk‰‰nt‰ji‰. Kolmannessa luvussa 
k‰yd‰‰n l‰pi korkean tason ohjelmointikielten historiaa noin kahden vuosikymmenen
ajalta. Luvussa l‰pik‰yd‰‰n useita kuvausj‰rjestelmi‰ Turingin formalismita FORTRAN:n julkaisuun.
Luvusta nelj‰ alkaen painopisteen‰ on k‰‰nt‰jien toteutus karkealla tasolla. Ensin k‰sitell‰‰n
Ristiink‰‰nt‰mist‰ ja v‰likieli‰. Luvussa viisi tutustutaan T-kaavioihin, joita apuna k‰ytt‰en
luvussa kuusi k‰sitell‰‰n ketjutusta sek‰ k‰‰nt‰jien rakennetta.
...
-ei ole t‰sm‰llinen  m‰‰ritelm‰ koska kykenev‰t myˆs direktiiveihin (pseudok‰sky) -sivu 1
-operation of assembler reflects the architecture of the computer. -sivu 2
-direktiivej‰ ei k‰‰nnet‰.
-object file sivu 3

-one pass, two pass sivu 3-4


-jokainen rivi l‰hdekoodissa on joko k‰sky tai direktiivi - situ 13 kun label k‰ytet‰‰n operandiana niin sit‰ kutsutaan symboliksi

-opcode table sivu 17 staattinen

-symboli m‰‰ritell‰‰n kirjoittamalla se labeliksi ja k‰ytet‰‰n kirjoittamalla operandiksi -s 17

-literal table 43

-direktiivit on suoritettu by assembler not assembled by it
- makrot jo 50 luvulla s 109 makrot on direktiivej‰ mutta monimutkaisia joten ajatellaan ominaisuuksina

- s110
-0 pass meinaa makrojen suoritusta. 121


\subsection{Ensimm‰iset assemblyk‰‰nt‰j‰t}
%Ensimm‰iset ohjelmointia helpottavat ohjelmat olivat assemblerk‰‰nt‰ji‰.

-ibm 704 oli floatit  ja index rekisteri 1956 ja sen eka assembleri UASAP-1  -sivyu 8
     se oli yksinkertainen ja teki vain 1:1 k‰‰ntˆ‰, tuki myˆhemmin makroja

- samana vuonna 56  ibm 702 kone asembler tuki ensimm‰isen‰ makroja

-conwayn 58 julkasema UNISAP assembleri univac 1 ja 2 koneelle  oli eka joka k‰ytti paikallisia labeleita.
  -idea se ett‰ paikallisen nimen ei tarvi olla kuvaava  s37

Ensimm‰iseet assemblyk‰‰nt‰j‰t olivat niin sanottuja assemble-go k‰‰nt‰ji‰. Ainoa
mit‰ ne osasivat tehd‰ oli l‰hdekoodin k‰‰nt‰minen suoraan muistiin ja sen suorittaminen ~\cite[2]{Salomon93}.
...
tietokoneita. Sen kehitettiin Cambridgen yliopistossa ja saatiin k‰yttˆvalmiiksi vuonna 1949 ~\cite[7]{Salomon93}.
...
EDSAC:n kehitt‰j‰ Maurice Wilkes ehdotti myˆs tunnusten (label) sek‰ makrojen
k‰yttˆ‰ symbolisten konekielten k‰‰nt‰jiin ~\cite[7]{Salomon93}. Tunnusten avulla,
joita h‰n kutsui liukuviksi osoitteiksi, ohjelmoijan ei en‰‰ tarvinnut
pit‰‰ kirjaa koodirivien osoitteista.



Vaikka korkean tason kielten k‰‰nt‰j‰t alkoivat kehitty‰
l‰hes heti ensimm‰isten assemblyk‰‰nt‰jien valmistuttua, pysyi symbolisilla
konekielill‰ ohjelmointi pitk‰‰n suosiossa. 
...
konekieli silti usein tehokkaampaa. T‰m‰n takia symbolisia %LƒHDE PYYDETTY aiempi lause, MUTTA TY÷LƒƒMPƒƒ
...
laitteistoriippuvaista tietyn prosessorin ymm‰rt‰m‰‰ konekielt‰. Siit‰ huolimatta,
...
\begin{table}[h!]
  \centering
  \caption{Yhteenveto ohjelmointikielten ja kuvausj‰rjestelmien kehityksest‰.} %t‰m‰ teksti pit‰‰ muuttaa
  \label{tab:table1}
  \begin{tabular}{| l | l | l |}
    \hline
...
T‰llˆin tarvittavien k‰‰nt‰jien m‰‰r‰ on $N \cdot M$ ja se kasvaa neliˆisesti kohde- ja l‰hdekielien
...
konekielell‰, koska muita ohjelmointikieli‰ ei viel‰ ollut.
Koska konekielen ohjelmointi oli tyˆl‰st‰ ja virhealtista, kehitettiin
avuksi symbolisia konekieli‰, joissa tietyt bin‰‰rijonot oli korvattu
...
tietokoneiden toimintaa korkeammalla abstraktiotasolla. Formaalien
kuvausj‰rjestelmien eli korkean tason ohjelmointikielten kehittyess‰
kokeiltiin myˆs konekielen tuottamista automaattisesti korkean
tason kielen mukaan. T‰m‰ automaattiseksi ohjelmoinniksi
ja myˆhemmin k‰‰nt‰miseksi kutsuttu prosessi oli alkuun melko tehotonta.
Moni tutkija pitikin sit‰ vain teoreettisena tutkimuksena, mutta
potentiaali niiden tehokkaaseen k‰yttˆˆn selvisi varsin nopeasti.
Ohjelmointikielten ja k‰‰nnˆstekniikan kehittyess‰ generoidun koodin
laatu parani, ja korkean tason ohjelmointikieli‰ ruvettiin kehitt‰m‰‰n
automaattisen koodin generoinnin takia. Viimeist‰‰n FORTRAN:n julkaisun j‰lkeen
korkean tason ohjelmointikielten hyˆdyt olivat laajasti hyv‰ksytty.

%k‰‰nt‰jien rakenne ja v‰likielet
Ensimm‰iset k‰‰nt‰j‰t kehitettiin vartavasten tietyn l‰hde- ja
...
l‰likielest‰, jonka avulla tarvittavien k‰‰nt‰jien
m‰‰r‰‰ voitaisiin pienent‰‰ ja ohjelmien tuottaminen uusille laitteistoille
nopeutuisi. Vaikka mik‰‰n v‰likieli ei ikin‰ saanut universaalia asemaa,
k‰ytet‰‰n silti l‰hes kaikissa k‰‰nt‰jiss‰ jotakin v‰likielt‰ k‰‰nnˆksen v‰livaiheena.
...
Lis‰ksi useat k‰‰nt‰j‰t toteutetaan rakenteella,
joka mahdollistaa niiden ketjuttamisen uusille tietokoneille mahdollisimman
v‰h‰ll‰ uudelleenohjelmoinnilla.
