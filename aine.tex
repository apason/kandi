...
joita h‰n kutsui liukuviksi osoitteiksi, ohjelmoijan ei en‰‰ tarvitsisi
pit‰‰ kirjaa koodirivien osoitteista.

IMB 704/702 tietokoneet valmistuivat 1956. Niiden ensimm‰inen assemblyk‰‰nt‰j‰
...
Melwin Conwayn julkaisema UNISAP k‰‰nt‰j‰ oli ensimm‰inen, joka mahdollisti %univacille
kahden erilaisen tunnuksen k‰ytˆn, paikallisen sek‰ globaalin~\cite[37]{Salomon93}.

Vaikka korkean tason kielten k‰‰nt‰ji‰ alettiin kehitt‰‰
pian ensimm‰isten assemblyk‰‰nt‰jien valmistuttua, pysyi symbolisilla
konekielill‰ ohjelmointi pitk‰‰n suosiossa. 
Nykyaikaiset korkean tason ohjelmointikielien k‰‰nt‰j‰t tuottavat %l‰hde t‰h‰nkin
...
tuottaa t‰st‰ konekielisen ohjelman. %pit‰s eka linkkaa
...
%labelit
Symbolisten konekieleten k‰‰nt‰minen tapahtuu suurimmaksi osaksi yksi yhteen edell‰ kuvatulla
tavalla. Poikkeuksen muodostaa tunnukset, jotka k‰sitell‰‰n ohjauskooditaulukosta
poiketen dynaamisessa muistirakenteessa. Tunnukset ovat symbolisia nimi‰ muistipaikoille
tai muuttujina k‰ytetyt muistipaikat. Niiden arvot m‰‰r‰ytyv‰t vasta k‰‰nnˆksen yhteydess‰.
Tunnusten avulla muistipaikat voidaan nimet‰ eik‰ ohjelmoijan tarvitse pit‰‰
kirjaa konek‰skyjen osoitteista. Tunnuksia voi myˆs k‰ytt‰‰ muuttujien tapaan.
Useissa ohjelmointikieliss‰ on direktiivi, jolla voidaan varata muistia tietyn
tunnuksen osoittamaan paikkaan. 
%label ja konek‰sky ero. staattinen-dynaaminen
...
symbolista konekielt‰~\cite[109]{Salomon93}. Makroilla on
