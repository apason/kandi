...
Kuva X demonstroi usein k‰ytetty‰ rakennetta ~\cite{Earley70}, jolla k‰‰nt‰j‰n jatkokehityst‰ voidaan
helpottaa huomattavasti. Uuden ohjelmointikielen toteuttaminen kyseisen k‰‰nt‰j‰n avulla on mahdollista
korvaamalla toisen vaiheen ensimm‰inen k‰‰nt‰j‰ (v‰rill‰ x) siten, ett‰ uusi l‰hdekieli (SL2)
...
se k‰‰nt‰‰ v‰likielt‰ IL uuden laitteiston ymm‰rt‰m‰lle konekielelle ML2.  Kun kyseist‰
osa k‰‰nnte‰‰n jo olemassa olevalla v‰rill‰ Z merkityll‰ k‰‰nt‰j‰ll‰, saadaan tulokseksi
...
Kuva X havainnollistaa t‰t‰ prosessia. Ensimm‰isess‰ vaiheessa jo olemassaolevien
komponenttien sek‰ uuden CWL:ll‰ kirjoitetun v‰likielik‰‰nt‰j‰n avulla v‰likielell‰
toimiva v‰likielik‰‰nt‰j‰ konekielelle ML2 sek‰ t‰m‰n avulla konekielell‰ ML1 toimiva
v‰likielik‰‰nt‰j‰ konekielelle ML2. N‰iden komponenttien avulla voidaan toisessa
...
Toisessa ja kolmannessa vaiheessa saadut k‰‰nt‰j‰t sijoittamalla alkuper‰iseen
